...
const WORLDBANK_SERIES: WbSeries[] = [
  ...
  { name: "Soybeans", code: "SOJA_WB", labelPt: "Soja (FOB US Gulf, referência global)", labelEn: "Soybeans (FOB US Gulf)", unit: "USD/mt", category: "agro", market: null },
  { name: "Maize", code: "MILHO_WB", labelPt: "Milho (FOB US Gulf, referência global)", labelEn: "Maize (FOB US Gulf)", unit: "USD/mt", category: "agro", market: null },
  { name: "Wheat, US HRW", code: "TRIGO_WB", labelPt: "Trigo (US HRW, FOB Golfo)", labelEn: "Wheat, US HRW (Gulf)", unit: "USD/mt", category: "agro", market: null },
  { name: "Rice, Thai 5%", code: "ARROZ_WB", labelPt: "Arroz (Tailândia 5%, FOB Bangkok)", labelEn: "Rice, Thai 5% (FOB Bangkok)", unit: "USD/mt", category: "agro", market: null },
  { name: "Groundnuts", code: "AMENDOIM_WB", labelPt: "Amendoim (CFR Europa)", labelEn: "Groundnuts (CFR Europe)", unit: "USD/mt", category: "agro", market: null },
