    ...
    <main className="pt-14 min-h-screen bg-[#08090C]">
      ...
      <div className="p-4 sm:p-8 max-w-[1600px] mx-auto space-y-4">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-4 bg-[#12141A] border border-white/5 rounded-sm p-5 row-span-2">
               ...
               <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Condi├º├úo Gamma</p>
                    <p className="text-[#4CAF50] font-mono text-lg">Positivo</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Vol. Impl├¡cita 30D</p>
            ...
            <div className="lg:col-span-8 bg-[#12141A] border border-white/5 rounded-sm p-5">
               <div className="text-center mb-6">
                  ...
                  <p className="text-[10px] text-muted-foreground font-light tracking-wide mt-1">Nosso score quantitativo que condensa dados operacionais em sinais de a├º├úo.</p>
               </div>
               ...
               <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  ...
                  <div className="bg-[#0b1324]/50 border border-white/5 p-4 text-center">
                     ...
                     <p className="text-[9px] text-[#A6C4FA] uppercase tracking-wider">Op├º├Áes</p>
                  </div>
                  {/* Volatility */}
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-8 bg-[#12141A] border border-white/5 rounded-sm p-5">
               <div className="flex justify-between items-center mb-6">
                  <div>
                    <h3 className="text-white font-display text-lg tracking-widest">Exposi├º├úo Gamma L├¡quida (GEX)</h3>
                    <p className="text-[10px] text-muted-foreground">Analisa as m├®tricas de formadores de mercado para antecipar pontos de rejei├º├úo de pre├ºo.</p>
                  </div>
            ...
            <div className="lg:col-span-4 bg-[#12141A] border border-white/5 rounded-sm p-5">
               <h3 className="text-white font-display text-lg tracking-widest mb-1">N├¡veis Principais</h3>
               <p className="text-[10px] text-muted-foreground mb-6">Sum├írio de pontos nodais na estrutura de precifica├º├úo.</p>
               
               <div className="grid grid-cols-2 gap-y-4 gap-x-2">
                  <div className="bg-[#0b1324] border border-white/5 p-2 px-3">
                     <p className="text-[9px] text-[#A6C4FA] uppercase tracking-widest mb-1">Resist├¬ncia de Call</p>
                     <p className="text-white font-mono text-sm leading-none">2450.00</p>
                  </div>
                  <div className="bg-[#0b1324] border border-white/5 p-2 px-3">
                     <p className="text-[9px] text-[#A6C4FA] uppercase tracking-widest mb-1">N├¡vel de Alta Vol</p>
                  ...
                  <div className="bg-[#0b1324] border border-white/5 p-2 px-3">
                     <p className="text-[9px] text-[#A6C4FA] uppercase tracking-widest mb-1">M├íxima Di├íria (1DMax)</p>
                  ...
                  <div className="bg-[#0b1324] border border-white/5 p-2 px-3">
                     <p className="text-[9px] text-[#A6C4FA] uppercase tracking-widest mb-1">Dist├óncia p/ Alta Vol</p>
         ...
         <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-[#12141A] border border-white/5 rounded-sm p-4 h-[220px] flex flex-col">
               <h3 className="text-white font-display text-sm tracking-widest mb-1">Hist├│rico de Momentum</h3>
            ...
            <div className="bg-[#12141A] border border-white/5 rounded-sm p-4 h-[220px] flex flex-col">
               <h3 className="text-white font-display text-sm tracking-widest mb-1">Hist├│rico de Volatilidade</h3>
               <div className="flex-1 w-full mt-2">
                  <ResponsiveContainer width="100%" height="100%">
                     <LineChart data={scoreHistoryData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                        <XAxis dataKey="d" tick={{ fill: "#666", fontSize: 9 }} axisLine={false} tickLine={false} />
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-8 pt-8 border-t border-white/5">
            <div className="lg:col-span-12 mb-2">
               <h3 className="text-white font-display text-xl tracking-widest flex items-center gap-2">
                 ZONA PILOTO <span className="text-primary">ÔÇó GOI├üS</span>
               </h3>
               <p className="text-[10px] text-muted-foreground uppercase tracking-widest mt-1">Infraestrutura Log├¡stica e Financeira Regional</p>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
               {[
                  { name: "Goi├ónia", role: "Hub Financeiro", desc: "Capital e polo de regula├º├úo e estrutura├º├úo de opera├º├Áes financeiras (R$ 12B PIB)." },
                  { name: "Bras├¡lia", role: "Capital Federal", desc: "Governan├ºa estrat├®gica, compliance e regula├º├úo macro." },
                  { name: "Rio Verde", role: "Soja & Milho", desc: "Principal n├│ de escoamento. Exporta├º├úo direta de US$ 4.2B anuais." },
                  { name: "Jata├¡", role: "Gr├úos & Prote├¡na", desc: "Top 10 Nacional em volume agropecu├írio estruturado." },
                  { name: "Catal├úo", role: "Ni├│bio & Minera├º├úo", desc: "Base de dep├│sitos minerais estrat├®gicos e base CMOC/Niobras." },
                  { name: "Campos Verdes", role: "Esmeraldas", desc: "Polo mundial de extra├º├úo de gemas com lastro tang├¡vel." },
               ].map((city, idx) => (
